...
| Issue | Description |
|-------|-------------|
| [Automating Market Search by Category](market-search-automation.md) | How to fetch market data from an API for AI analysis instead of manually copying or using spreadsheets |
